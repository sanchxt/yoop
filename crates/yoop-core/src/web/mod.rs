//! Embedded web server for Yoop.
//!
//! The web interface requires **zero external infrastructure**. The Yoop
//! binary serves a web UI accessible to browsers on the same network.
//!
//! ## Starting Web Mode
//!
//! ```bash
//! yoop web                     # Default port 8080
//! yoop web --port 9000         # Custom port
//! yoop web --localhost-only    # Restrict to localhost
//! yoop web --auth              # Enable authentication
//! ```
//!
//! ## API Endpoints
//!
