//! Integration tests for `Yoop` file transfers.
//!
...
use yoop_core::code::ShareCode;
use yoop_core::transfer::{ReceiveSession, ShareSession, TransferConfig, TransferState};
...
async fn test_single_file_transfer() {
    ...
    let test_content = b"Hello, Yoop! This is a test file.";
